...
import { Download, RefreshCw, WifiOff, X, Sparkles, CheckCircle2 } from 'lucide-react';
...
export const PWAUpdateNotification: React.FC<{
  ...
  return (
    <aside
      ...
      className="fixed bottom-6 right-6 z-50 max-w-sm w-full bg-slate-900/95 backdrop-blur-md border border-sky-500/40 text-white p-4 rounded-2xl shadow-2xl animate-in fade-in slide-in-from-bottom-5 duration-300 font-sans"
    >
